        ...
        <ResponsiveBar
          ...
          tooltip={({ id, value, indexValue }) => {
            ...
            return (
              ...
              >
                <strong>{id}</strong>: {Math.round(value).toLocaleString()}
                <br />
                <small>
...
export default PlaylistEfficiencyChart;
